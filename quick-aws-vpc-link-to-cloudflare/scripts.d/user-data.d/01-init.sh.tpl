...
sudo cloud-init-per once get_awscliv2 curl https://awscli.amazonaws.com/awscli-exe-linux-aarch64.zip -o awscliv2.zip
...
# Docker
#---------------------------------------------------------------------------------------------------
sudo cloud-init-per once enable_docker systemctl enable docker
sudo cloud-init-per once start_docker systemctl start docker

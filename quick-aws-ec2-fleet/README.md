...
Terraform project which creates a VPC and Auto Scaling Group on AWS from scratch.
...
cd quick-aws-projects/quick-aws-ec2-fleet
terraform workspace new quick-aws-ec2-fleet-dev 2>/dev/null
terraform workspace select quick-aws-ec2-fleet-dev
terraform init
terraform apply
```
